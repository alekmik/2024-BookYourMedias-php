...
try {
    ...
    $pdo->exec("INSERT INTO medias (titre, published_date, description_media, image_couverture, lien_extrait, disponible, id_categorie, id_auteur) VALUES 
    ('Les Misérables', '1890-01-01', 'Plongez dans le chef-d\'œuvre intemporel de Victor Hugo avec Les Misérables. Suivez l\'histoire poignante de Jean Valjean, de Fantine, de Cosette et des autres personnages inoubliables dans le contexte de la France du XIXe siècle. Cette épopée sociale explore des thèmes universels tels que la justice, l\'amour et la rédemption, et continue de toucher les lecteurs du monde entier.', 'https://cdn1.booknode.com/book_cover/83/les_miserables-83116-264-432.jpg', 'https://www.google.fr/books/edition/Les_mis%C3%A9rables/wzDr2I8DWMAC?hl=fr&gbpv=1&pg=PP9&printsec=frontcover', 1, 1, 7)");
    $pdo->exec("INSERT INTO medias (titre, published_date, description_media, image_couverture, lien_extrait, disponible, id_categorie, id_auteur) VALUES 
    ...
    $pdo->exec("INSERT INTO medias (titre, published_date, description_media, image_couverture, lien_extrait, disponible, id_categorie, id_auteur) VALUES 
    ('Parasite', '2019-05-21', 'Découvrez le film sud-coréen récompensé aux Oscars, Parasite, réalisé par Bong Joon-ho. Cette œuvre cinématographique novatrice explore les tensions sociales à travers l\'histoire d\'une famille qui infiltre la vie d\'une famille fortunée.', 'https://doublemarge.com/wp-content/uploads/2020/02/Parasite-affiche.jpg', 'https://www.youtube.com/watch?v=-Yo_lxZ6Z0k', 1, 2, 14)");
    $pdo->exec("INSERT INTO medias (titre, published_date, description_media, image_couverture, lien_extrait, disponible, id_categorie, id_auteur) VALUES 
    ...
    $pdo->exec("INSERT INTO medias (titre, published_date, description_media, image_couverture, lien_extrait, disponible, id_categorie, id_auteur) VALUES 
    ('Alice au Pays des Merveilles', '2010-03-03', 'Explorez une version visuellement époustouflante du Pays des Merveilles avec Alice au Pays des Merveilles réalisé par Tim Burton. Ce film combine habilement le style distinctif de Burton avec l\'histoire classique de Lewis Carroll. Suivez Alice, interprétée par Mia Wasikowska, dans son voyage fantastique rempli de personnages excentriques, de créatures magiques et d\'aventures étranges. Avec des effets visuels éblouissants et une interprétation captivante, le film offre une expérience cinématographique unique.', 'https://i.pinimg.com/564x/1d/71/66/1d7166ccf50d11724fc9f8d047c5ddd8.jpg', 'https://www.youtube.com/watch?v=c4ais9sftFE', 1, 2, 17)");
    $pdo->exec("INSERT INTO medias (titre, published_date, description_media, image_couverture, lien_extrait, disponible, id_categorie, id_auteur) VALUES 
